...
<html>
	...
	<body style=" background-image:url(images/c1.jpg); background-repeat: no-repeat;background-size: cover;background-attachment: fixed;">
...
<div class ="clerkdata" >
 ...
 <table border = "0" width ="25%">
	 <tr>
		<td>Clerk Id</td>
		<td><input type="text" value = "<?php echo " $clerkID"?>"name="clerk1" readonly /></td>
	 </tr>
	  <tr>
		<td>Clerk Name</td>
		<td><input type="text" value = "<?php echo "$clerkname"?>" name="clerk2" /></td>
	 </tr>
	 <tr>
		<td>Email</td>
		<td><input type="text" value = "<?php echo "$email"?>" name="clerk3" /></td>
	 </tr>
	 <tr>
		<td>Mobile</td>
		<td><input type="text" value = "<?php echo "$mobile"?>" name="clerk4" /></td>
	 </tr>
	 <tr>
		<td>Password</td>
		<td><input type="text" value = "<?php echo "$password"?>" name="clerk5" /></td>
	 </tr>
