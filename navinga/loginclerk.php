...
<html>
 ...
 <link rel="shortcut icon"  href="images/1111.png" />
		...
		<link rel="stylesheet" href="css/loginclerk.css">
        <script src="js/showpassword.js"></script>
 </head>
 
 <body style="background-image:url('images/transparent.png')">
...
{
if(!empty($_POST['clerkname'])&& !empty ($_POST ['password'])){
    $clerkname= $_POST ['clerkname'];
    $password=  $_POST ['password'];

   
    $sql="SELECT * FROM clerk WHERE clerkname='$clerkname'AND password='$password'";
...
<nav>
  ...
  <div class="loginbox">
  <h2>Login as Library clerk</h2>
 <form method="POST" action="loginclerk.php">
<label><b>Username</b></label>
 <input type="text" placeholder="Enter Username" name="clerkname" required>
 </BR> </BR>
