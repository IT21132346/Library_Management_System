...
<html>
	...
	<div class="side">
		<ul class="side"style = "margin-top: 15;">
...
<div class = "form">
<div style = "position:relative;top:8px;color:#34282C;font-size:30px;"><center><b>Edit Clerk </b></center></div>		
<div class ="clerkdata">
 <form action="editclerkrecord.php" method = "GET" name = "form2">
 <table border = "0" width ="25%">
	 <tr>
		<td>Clerk Id</td>
		<td><input type="text" value = "<?php echo "$clerkID"?>"name="field1" readonly /></td>
	 </tr>
	  <tr>
		<td>Clerk Name</td>
		<td><input type="text" value = "<?php echo "$clerkname"?>" name="field2" /></td>
	 </tr>
	 <tr>
		<td>Email</td>
