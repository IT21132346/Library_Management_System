<html>
	...
	<body style=" background-image:url(images/is1.jpg); background-repeat: no-repeat;background-size: cover;background-attachment: fixed;">
	...
	<div class="side">
		<ul class="side">
			<li><a class="side" href="librarianProfile.php" >Profile</a></li>
