...
<?php require "config.php" ?>
	...
	<div class="side" style = "margin-top: -7px;">
		<ul class="side">
	...
	<!--Add Assistant-->
	<div class="content">
	<div style = "position:relative;top:60px;color:#34282C;font-size:30px;"><center><b>Add Assistant</b></center></div>	
		<img src="images/user.png" alt="user.png">
		<div class="container">
			<form method="POST"  action="addaassistant.php" >
					
				
				<label class="ab" for="uname">Name : </label>				
				<input class="cd" style="margin-left:78px" type="text" value="" id="aname" name="aname" required> </br>
				
				
				<label class="ab" for="email">Email : </label>				
				<input class="cd" style="margin-left:91px" type="email" placeholder="abc@gmail.com" pattern ="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}" value="" id="aemail" name="aemail" required> </br>
				
				
				<label class="ab" for="mobile">Mobile number : </label>				
				<input class="cd" style="margin-left:24px" type="text" value="" id="a-mob_number" name="amobile" placeholder= "o773868***" required> </br>
				...
				<div class="gh">
				<input type="submit" value="submit" onmouseover="checkpasswords()" name = "submit">
